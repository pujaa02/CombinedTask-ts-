...
route.get("/att", checkauth_1.default, (req, res) => {
    let m, y;
    ...
    const q = `SELECT student_master26.id, student_master26.firstname,
...
route.get("/att/:fd", checkauth_1.default, (req, res) => {
...
route.get("/data/:fd", checkauth_1.default, (req, res) => {
    const field = req.params.fd;
    let m, y;
    if (req.query.months && req.query.year) {
        m = parseInt(req.query.months);
